...
st.set_page_config(
    page_title="AI Medical Imaging",
    page_icon="../../favicon.ico",
    layout="wide"
)

# Simpan API Key di session state
...
# Konfigurasi Medical Agent menggunakan OpenAI
medical_agent = Agent(
    model=OpenAIChat(
        api_key=st.session_state.OPENAI_API_KEY,
        id="gpt-4o",  # Gunakan model OpenAI yang Anda inginkan
        vision=True
    ),
    tools=[DuckDuckGo()],
    markdown=True
